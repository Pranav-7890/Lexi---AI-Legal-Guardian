        ...
        <div className="p-8 sm:p-12 space-y-12 text-slate-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
              <Shield className="text-blue-600 w-6 h-6" /> Our Mission
            </h2>
            <p className="mb-4">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                <h3 className="font-bold text-lg mb-2 text-slate-800">The "Legalese" Barrier</h3>
              ...
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                <h3 className="font-bold text-lg mb-2 text-slate-800">High Costs & Inaccessibility</h3>
                <p className="text-sm text-slate-600">
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="shrink-0 mt-1">
                  <div className="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 font-bold">1</div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Smart Document Generation</h3>
                  <p>
              ...
              <div className="flex gap-4">
                <div className="shrink-0 mt-1">
                  <div className="w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center text-teal-600 font-bold">2</div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-slate-900 mb-2">Legal X-Ray (Analysis)</h3>
                  <p>
                  ...
                  <ul className="list-disc ml-4 mt-2 space-y-1 text-slate-600">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
              <BrainCircuit className="text-violet-600 w-6 h-6" /> Under the Hood
            </h2>
            <p className="mb-4">
            ...
            <ul className="grid sm:grid-cols-2 gap-4">
                <li className="flex items-start gap-3">
                    ...
                    <div>
                        <strong className="block text-slate-900">Gemini 3.0 Pro</strong>
                ...
                <li className="flex items-start gap-3">
                    <div className="w-2 h-2 mt-2 rounded-full bg-violet-500 shrink-0"></div>
                    <div>
                        <strong className="block text-slate-900">Gemini 2.5 Flash</strong>
          ...
          <hr className="border-slate-100" />
           ...
           <section className="bg-slate-50 p-6 rounded-xl border border-slate-200">
            <h2 className="text-lg font-bold text-slate-900 mb-2 flex items-center gap-2">
              <Lock className="text-slate-500 w-5 h-5" /> Important Disclaimer
            </h2>
            <p className="text-sm text-slate-600">
